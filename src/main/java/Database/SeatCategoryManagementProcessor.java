...
public class SeatCategoryManagementProcessor extends Processor {
    ...
    public Response getData(int from, int quantity, String queryCondition, String sortQuery) {
        ...
        return select("SEAT_CATEGORY.ID AS 'SEAT_CATEGORY.ID', SEAT_CATEGORY.CATEGORY AS 'SEAT_CATEGORY.CATEGORY', SEAT_PRICES.PRICE AS 'SEAT_PRICES.PRICE', SEAT_PRICES.ID AS 'SEAT_PRICES.ID'", from, quantity, queryCondition, sortQuery, "SEAT_CATEGORY, SEAT_PRICES");
    }
}
