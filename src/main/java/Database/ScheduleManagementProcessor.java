...
public class ScheduleManagementProcessor extends Processor {
    ...
    public Response getData(int from, int quantity, String queryCondition, String sortQuery) {
        if (queryCondition.length() > 0) {
            ...
            return select("SCHEDULES.ID AS 'SCHEDULES.ID', SCHEDULES.STATUS AS 'SCHEDULES.STATUS', SCHEDULES.SHOW_DATE AS 'SCHEDULES.SHOW_DATE', SHOW_TIMES.START_TIME AS 'SHOW_TIMES.START_TIME', MOVIES.TITLE AS 'MOVIES.TITLE', SCREEN_ROOMS.NAME AS 'SCREEN_ROOMS.NAME', CINEMAS.NAME AS 'CINEMAS.NAME'", from, quantity, queryCondition, sortQuery, "SCHEDULES, MOVIES, SHOW_TIMES, SCREEN_ROOMS, CINEMAS");
    }
}
