...
DELIMITER //
CREATE PROCEDURE updateUserCategory(user_id VARCHAR(10))
BEGIN
...
DELIMITER //
CREATE PROCEDURE singUpProcrdure(user_id varchar(10), authen_id varchar(10),
...
SET USER_ID = (SELECT U.ID FROM USERS U WHERE U.EMAIL = email);
IF (USER_ID = NULL) THEN
	INSERT INTO USERS VALUES (user_id, firstname, lastname, dob, address, phone, email, 'CUSTOMER', 0, USERCATEGORY);
    INSERT INTO AUTHENTICATION VALUES (authen_id, username, pass);
ELSE
