...
USE MOVIE;
update user_category set point_lowerbound = 4000 where id = 'uc_00003';
SELECT * FROM USER_CATEGORY;
SELECT * FROM PRICES;
SELECT ITEMS.ID AS 'ITEMS.ID', ITEMS.NAME AS 'ITEMS.NAME', ITEM_CATEGORY.CATEGORY AS 'ITEM_CATEGORY.CATEGORY', PRICES.PRICE AS 'PRICES.PRICE', ITEMS.REVENUE AS 'ITEMS.REVENUE' FROM ITEMS, ITEM_CATEGORY, PRICES WHERE ITEM_CATEGORY.ID = ITEMS.ITEM_CATEGORY_ID AND PRICES.COMPONENT_ID = ITEM_CATEGORY.ID LIMIT 0, 11;
...
-- SELECT A.PASS AS PASSWORD FROM USERS U, AUTHENTICATION A WHERE A.USER_ID = U.ID AND U.USERNAME = 'admin1' LIMIT 0, 1;
-- select * from authentication;
