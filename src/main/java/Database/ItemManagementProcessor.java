...
public class ItemManagementProcessor extends Processor {
    ...
    public Response getData(int from, int quantity, String queryCondition, String sortQuery) {
        ...
        Response response = select("ITEMS.ID AS 'ITEMS.ID', ITEMS.STATUS AS 'ITEMS.STATUS', ITEMS.NAME AS 'ITEMS.NAME', ITEMS.QUANTITY AS 'ITEMS.QUANTITY', ITEMS.UNIT AS 'ITEMS.UNIT', ITEM_CATEGORY.CATEGORY AS 'ITEM_CATEGORY.CATEGORY', ITEM_PRICES.PRICE AS 'ITEM_PRICES.PRICE', ITEMS.REVENUE AS 'ITEMS.REVENUE'", from, quantity, queryCondition, sortQuery, "ITEMS, ITEM_CATEGORY, ITEM_PRICES");
        return response;
    }
